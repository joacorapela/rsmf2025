...
\paragraph{Summary:}
Collaborate with experimental neuroscientists to help
...
Propagation algorithm~\cite{minka01}, and is the lead developer of Infer.NET.
Please refer to his letter of support.

\paragraph{Responsible team member:} JR (is experience in C\#, Bonsai and
probabilistic inference by message passing).
...
\begin{description}
    ...
    \item[Every three months:] we will hold meetings between the project lead, TMF, the
        senior project co-lead, MS, the senior RSE, JR, the junior RSE, NG, and
