...
\begin{center}
    \includegraphics[width=7in]{figures/ganttChart1.gan_page0.png}
\end{center}
...
\bibliography{bonsai,longDurationExperimentation,physiology,optogenetics,closeLoopControlOfNeuralActivity,latentsVariablesModels,messagePassing}
